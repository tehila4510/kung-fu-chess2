...
set ENGINE_TEST_SOURCES=tests\test_main.cpp tests\RuleEngineTest.cpp tests\RealTimeArbiterTest.cpp tests\GameEngineTest.cpp tests\BoardMapperTest.cpp tests\ControllerTest.cpp tests\BoardIOTest.cpp tests\GraphicsBoardLayoutTest.cpp tests\GraphicsConfigTest.cpp tests\GraphicsAssetPathsTest.cpp tests\MatchQueueTest.cpp tests\ConnectionRegistryTest.cpp src\server\MatchQueue.cpp src\server\ConnectionRegistry.cpp %ENGINE_SOURCES%
